...
export default function AdminSignInPage() {
  ...
  const {
    ...
    onSubmit: async (emailValue, passwordValue) => {
      ...
      const ok = emailValue === "admin@trusteats.com" && passwordValue === "admin123";
  ...
  return (
    <div className="min-h-screen bg-[#eef4fc] flex flex-col">
      ...
      <div className="flex-1 flex items-start justify-center px-5 md:px-6 pb-10">
        <div className="w-full max-w-[420px] md:max-w-[700px] md:bg-white md:border md:border-green-100 md:shadow-sm rounded-none md:rounded-2xl p-0 md:p-12 mt-6 md:mt-20 lg:mt-28">
            ...
            <form onSubmit={handleSubmit} noValidate>
              <div className="mb-4 md:mb-5">
                ...
                <input
                  ...
                  className={[
                    "w-full px-4 py-3 md:py-3.5 rounded-lg border text-sm md:text-base placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2F6844]",
                    errors.email ? "border-red-400" : "border-gray-300",
                  ].join(" ")}
                />
                {errors.email && (
                  <p id="admin-email-error" className="mt-1.5 text-xs font-medium text-red-600">
                    {errors.email}
                  </p>
                )}
              </div>
              ...
              <div className="mb-3 md:mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    className={[
                      "w-full px-4 py-3 md:py-3.5 pr-11 rounded-lg border text-sm md:text-base placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2F6844]",
                ...
                {errors.password && (
                  <p id="admin-password-error" className="mt-1.5 text-xs font-medium text-red-600">
                    {errors.password}
                  </p>
                )}
              </div>
              ...
              <button
                ...
                className="w-full py-3.5 md:py-4 rounded-lg border-[1.5px] border-[#2F6844] text-[#2F6844] text-base md:text-lg font-semibold hover:bg-green-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#2F6844]"
              >
                Sign Up
              </button>
            </form>
