    ...
    return (
        <div className="min-h-screen bg-[#F4F7F9] flex flex-col font-sans pb-24 relative">
            ...
            <div className="flex items-center px-4 py-6">
                ...
                <h1 className="text-[22px] font-bold text-[#292d32]">History</h1>
            </div>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col justify-center gap-1.5">
                                <h3 className="text-[16px] font-bold text-[#292d32] leading-tight">{item.name}</h3>
                                
                                {item.status === "Verified" && (
                                    <div className="flex items-center w-fit gap-1 rounded-full border border-[#bbf7d0] bg-[#f0fdf4] px-2 py-0.5 text-[11px] font-semibold text-[#3c7443]">
            ...
            {selectedProduct && (
                <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 sm:items-center">
                    ...
                    >
                        ...
                        {/* Top Section */}
                        <div className="rounded-2xl border-[1.5px] border-[#e2e8f0] bg-[#f8fafc] p-5 mb-5 flex gap-4 shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] items-center">
                            <div className="w-[100px] h-[130px] flex-shrink-0 bg-white rounded-xl border border-gray-100 p-2 shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]">
                                <img src={selectedProduct.image} alt={selectedProduct.name} className="w-full h-full object-contain" />
                            </div>
                            
                            <div className="flex flex-col items-center justify-center flex-1">
                                <div className="text-[#3c7443] mb-3">
                                    <BadgeCheck size={48} fill="#3c7443" color="white" strokeWidth={1.5} />
                                </div>
                                <div className="flex items-center gap-1.5 rounded-full border border-green-200 bg-green-50 px-3 py-1 text-xs font-semibold text-[#3c7443] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] mb-3">
                        ...
                        <div className="rounded-[1.25rem] border-[1.5px] border-[#3c7443]/40 bg-[#F4F7F9] p-5 shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]">
